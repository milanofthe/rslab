...
//!
//! Mirrors the five fixtures in `feral-ordering-core/tests/invariants.rs`
//! but exercises them through the public `feral-amf` API rather than
...
use feral_amf::{amf_order, amf_order_full, amf_order_with_stats, AmfOptions, CscPattern};
