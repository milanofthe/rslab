...
factorization is bit-identical regardless of the worker count. When the factor is made approximate --- static-pivoted or
...
($5.9\times$ sym / $5.0\times$ unsym). The heuristic pick's win over the fixed
