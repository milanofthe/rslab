...
fn run_case(label: &str, n: usize, rows: &[usize], cols: &[usize], vals: &[C]) {
    ...
    println!(
        "{:>5} {:>7} {:>9} {:>9}  {:>9.2} {:>9.3} {:>8.0e}  {:>9.2} {:>9.3} {:>8.0e}  {:>6.2}x  nnzL={}",
        label, n, nnz_lower, nnz_full, rla_fac, rla_slv, rla_res, faer_fac, faer_slv, faer_res,
        faer_fac / rla_fac, rla_nnz,
    );
}
...
fn main() {
    ...
    feral::set_use_gemm_schur(gemm_on);
    println!(
    ...
    // 2D 5-point grids: many small fronts.
    for &m in &[40usize, 80, 140, 180] {
