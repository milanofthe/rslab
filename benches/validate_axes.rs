...
const CORPUS: &[(&str, &str)] = &[
    ...
    ("HB", "bcsstk01"), ("HB", "bcsstk02"), ("HB", "bcsstk03"), ("HB", "bcsstk04"),
    ("HB", "bcsstk05"), ("HB", "bcsstk06"), ("HB", "bcsstk07"), ("HB", "bcsstk08"),
    ("HB", "bcsstk09"), ("HB", "bcsstk10"), ("HB", "bcsstk11"), ("HB", "bcsstk12"),
    ("HB", "bcsstk13"), ("HB", "bcsstk14"), ("HB", "bcsstk15"), ("HB", "bcsstk16"),
    ("HB", "bcsstk17"), ("HB", "bcsstk18"), ("HB", "bcsstk19"), ("HB", "bcsstk20"),
    ("HB", "bcsstk21"), ("HB", "bcsstk22"), ("HB", "bcsstk23"), ("HB", "bcsstk24"),
    ("HB", "bcsstk25"), ("HB", "bcsstk26"), ("HB", "bcsstk27"), ("HB", "bcsstk28"),
    ("HB", "bcsstm07"), ("HB", "bcsstm09"), ("HB", "bcsstm11"), ("HB", "bcsstm12"),
    ("HB", "bcsstm19"), ("HB", "bcsstm21"), ("HB", "bcsstm23"), ("HB", "bcsstm24"),
    ("HB", "bcsstm25"), ("HB", "bcsstm26"),
    ("HB", "nos1"), ("HB", "nos2"), ("HB", "nos3"), ("HB", "nos4"), ("HB", "nos5"),
    ("HB", "nos6"), ("HB", "nos7"), ("HB", "plat362"), ("HB", "plat1919"),
    ("HB", "lund_a"), ("HB", "lund_b"), ("HB", "gr_30_30"), ("HB", "494_bus"),
    ("HB", "662_bus"), ("HB", "685_bus"), ("HB", "1138_bus"), ("HB", "sherman1"),
    ("HB", "sts4098"), ("HB", "dwt_2680"), ("HB", "can_1054"), ("HB", "can_1072"),
    ("HB", "lshp3466"), ("HB", "zenios"),
    // Boeing.
    ("Boeing", "bcsstk34"), ("Boeing", "bcsstk38"), ("Boeing", "bcsstk39"),
    ("Boeing", "msc00726"), ("Boeing", "msc01050"), ("Boeing", "msc01440"),
    ("Boeing", "msc04515"), ("Boeing", "msc10848"), ("Boeing", "msc23052"),
    ("Boeing", "crystk01"), ("Boeing", "crystk02"), ("Boeing", "crystk03"),
    ("Boeing", "crystm01"), ("Boeing", "crystm02"), ("Boeing", "crystm03"),
    ("Boeing", "ct20stif"), ("Boeing", "pwtk"), ("Boeing", "pct20stif"),
    ("Boeing", "bcsstk36"), ("Boeing", "bcsstk37"),
    // Cylshell.
    ("Cylshell", "s1rmq4m1"), ("Cylshell", "s1rmt3m1"), ("Cylshell", "s2rmq4m1"),
    ("Cylshell", "s2rmt3m1"), ("Cylshell", "s3rmq4m1"), ("Cylshell", "s3rmt3m1"),
    ("Cylshell", "s3rmt3m3"), ("Cylshell", "s3dkt3m2"), ("Cylshell", "s3dkq4m2"),
    // Nasa.
    ("Nasa", "nasa1824"), ("Nasa", "nasa2146"), ("Nasa", "nasa2910"),
    ("Nasa", "nasa4704"), ("Nasa", "nasasrb"), ("Nasa", "shuttle_eddy"),
    ("Nasa", "skirt"), ("Nasa", "pwt"),
    // GHS_psdef.
    ("GHS_psdef", "wathen100"), ("GHS_psdef", "wathen120"), ("GHS_psdef", "apache1"),
    ("GHS_psdef", "jnlbrng1"), ("GHS_psdef", "torsion1"), ("GHS_psdef", "minsurfo"),
    ("GHS_psdef", "obstclae"), ("GHS_psdef", "gridgena"), ("GHS_psdef", "finan512"),
    ("GHS_psdef", "cvxbqp1"), ("GHS_psdef", "bloweybq"), ("GHS_psdef", "oilpan"),
    ("GHS_psdef", "vanbody"), ("GHS_psdef", "s3dkq4m2"), ("GHS_psdef", "s3dkt3m2"),
    ("GHS_psdef", "ford1"), ("GHS_psdef", "crankseg_1"), ("GHS_psdef", "crankseg_2"),
    ("GHS_psdef", "hood"), ("GHS_psdef", "bmw7st_1"), ("GHS_psdef", "bmwcra_1"),
    ("GHS_psdef", "olafu"), ("GHS_psdef", "gyro_k"), ("GHS_psdef", "gyro_m"),
    ("GHS_psdef", "bundle1"), ("GHS_psdef", "cfd1"), ("GHS_psdef", "cfd2"),
    ("GHS_psdef", "thread"), ("GHS_psdef", "m_t1"), ("GHS_psdef", "x104"),
    ("GHS_psdef", "shipsec1"), ("GHS_psdef", "shipsec5"), ("GHS_psdef", "shipsec8"),
    ("GHS_psdef", "copter2"), ("GHS_psdef", "ford2"),
    // GHS_indef.
    ("GHS_indef", "aug2d"), ("GHS_indef", "aug2dc"), ("GHS_indef", "aug3d"),
    ("GHS_indef", "aug3dcqp"), ("GHS_indef", "bloweya"), ("GHS_indef", "bratu3d"),
    ("GHS_indef", "cont-201"), ("GHS_indef", "cont-300"), ("GHS_indef", "dixmaanl"),
    ("GHS_indef", "dtoc"), ("GHS_indef", "helm2d03"), ("GHS_indef", "helm3d01"),
    ("GHS_indef", "k1_san"), ("GHS_indef", "linverse"), ("GHS_indef", "mario001"),
    ("GHS_indef", "ncvxbqp1"), ("GHS_indef", "sit100"), ("GHS_indef", "spmsrtls"),
    ("GHS_indef", "stokes64"), ("GHS_indef", "stokes128"), ("GHS_indef", "tuma1"),
    ("GHS_indef", "tuma2"), ("GHS_indef", "boyd1"), ("GHS_indef", "brainpc2"),
    ("GHS_indef", "darcy003"), ("GHS_indef", "dawson5"), ("GHS_indef", "exdata_1"),
    // Oberwolfach.
    ("Oberwolfach", "bodyy4"), ("Oberwolfach", "bodyy5"), ("Oberwolfach", "bodyy6"),
    ("Oberwolfach", "gyro"), ("Oberwolfach", "gyro_k"), ("Oberwolfach", "gyro_m"),
    ("Oberwolfach", "LF10"), ("Oberwolfach", "LFAT5"), ("Oberwolfach", "t2dah"),
    ("Oberwolfach", "t2dah_e"), ("Oberwolfach", "t2dal"), ("Oberwolfach", "t3dl"),
    ("Oberwolfach", "filter3D"), ("Oberwolfach", "flowmeter5"),
    // Simon / Rothberg / DNVS / FIDAP / misc.
    ("Simon", "raefsky4"), ("Simon", "olafu"), ("Simon", "venkat01"),
    ("Rothberg", "cfd1"), ("Rothberg", "cfd2"), ("Rothberg", "gearbox"),
    ("DNVS", "ship_001"), ("DNVS", "ship_003"), ("DNVS", "shipsec1"),
    ("DNVS", "shipsec5"), ("DNVS", "shipsec8"), ("DNVS", "fcondp2"),
    ("DNVS", "fullb"), ("DNVS", "halfb"), ("DNVS", "m_t1"), ("DNVS", "thread"),
    ("DNVS", "troll"), ("DNVS", "x104"), ("DNVS", "tsyl201"),
    ("FIDAP", "ex3"), ("FIDAP", "ex9"), ("FIDAP", "ex10"), ("FIDAP", "ex11"),
    ("FIDAP", "ex13"), ("FIDAP", "ex15"), ("FIDAP", "ex19"), ("FIDAP", "ex33"),
    ("FIDAP", "ex35"), ("FIDAP", "ex40"),
    ("Cunningham", "qa8fk"), ("Cunningham", "qa8fm"), ("Cunningham", "m3plates"),
    ("Um", "2cubes_sphere"), ("Um", "offshore"),
    ("Schmid", "thermal1"), ("Schmid", "thermal2"),
    ("Botonakis", "FEM_3D_thermal1"), ("Botonakis", "thermomech_dM"),
    ("Botonakis", "thermomech_dK"), ("Botonakis", "thermomech_TC"),
    ("Wissgott", "parabolic_fem"),
    ("Pothen", "barth"), ("Pothen", "barth4"), ("Pothen", "barth5"),
    ("Pothen", "bodyy4"), ("Pothen", "bodyy5"), ("Pothen", "bodyy6"),
    ("Pothen", "mesh1e1"), ("Pothen", "mesh2e1"), ("Pothen", "mesh3e1"),
    ("Pothen", "shuttle_eddy"), ("Pothen", "sphere2"), ("Pothen", "sphere3"),
    ("Pothen", "skirt"), ("Pothen", "onera_dual"), ("Pothen", "commanche_dual"),
    ("PARSEC", "Si2"), ("PARSEC", "SiH4"), ("PARSEC", "Si5H12"), ("PARSEC", "benzene"),
    ("Williams", "cant"), ("Williams", "consph"), ("Williams", "pdb1HYS"),
    ("Bai", "qc2534"),
];
...
#[cfg(feature = "matgen-download")]
fn main() {
    let mem_cap_mb: f64 = std::env::var("RLA_VAL_MEM_CAP_MB").ok()
        .and_then(|s| s.parse().ok()).unwrap_or(4000.0);
    let threads: usize = std::env::var("RLA_VAL_THREADS").ok()
        .and_then(|s| s.parse().ok()).unwrap_or(8);
    let max_mats: usize = std::env::var("RLA_VAL_MAX").ok()
    ...
    for &(group, name) in CORPUS.iter().take(max_mats) {
        let path = match rslab::matgen::download::fetch(group, name) {
            Ok(p) => p,
            Err(e) => { eprintln!("[val] skip {name}: fetch {e}"); skipped_fetch += 1; continue; }
        };
        let a = match rslab::read_mtx_any(&path) {
            Ok(rslab::MtxLoaded::Symmetric(a)) => a,
            Ok(rslab::MtxLoaded::General(_)) => { eprintln!("[val] skip {name}: general (LU path)"); continue; }
            Err(e) => { eprintln!("[val] skip {name}: parse {e}"); continue; }
        };
        if a.n == 0 { continue; }
        // A-priori memory gate so the run never OOMs.
        let sym = match LdltSymbolic::analyze(&a) { Ok(s) => s, Err(e) => { fail.push(format!("{name}: analyze {e:?}")); continue; } };
        ...
        let eager = solve_with(&base.clone().with_method(FactorMethod::Multifrontal).with_memory(MemoryMode::Eager));
        let lowm = solve_with(&base.clone().with_method(FactorMethod::Multifrontal).with_memory(MemoryMode::LowMemory));
        ...
        let thr = |cdiv| GemmThresholds { scalar_gate: 4096, par_gemm: 1_000_000, par_cdiv: cdiv };
        let par = solve_with(&base.clone().with_method(FactorMethod::Multifrontal).with_gemm_thresholds(thr(0)));
        let ser = solve_with(&base.clone().with_method(FactorMethod::Multifrontal).with_gemm_thresholds(thr(usize::MAX)));
        match (par.as_ref(), ser.as_ref()) {
            (Some(p), Some(s)) if bit_eq(p, s) => n_front += 1,
            (Some(_), Some(_)) => fail.push(format!("{name}: parallel front subtraction not bit-identical")),
            _ => {}
        }
        ...
        let sc_ok = |v: &Option<Vec<C>>| v.as_ref().map(|x| rel_residual(&a, x, &b) < 1e-4).unwrap_or(false);
        if sc_ok(&sc_auto) && sc_ok(&sc_inf) { n_scaling += 1; }
        else { eprintln!("[val] {name}: a scaling variant residual high (ill-conditioned)"); }
                ...
                if let Ok(raw2) = factor_sparse_ldlt_with(&a, &base) {
                    if let Some(comp) = CompressedLdltFactors::from_factors(raw2) {
                        if let Ok(cx) = comp.solve(&b) {
                            if bit_eq(&rx, &cx) { n_compress += 1; }
                            else { fail.push(format!("{name}: compressed != full solve")); }
                        }
                    }
                }
            }
        ...
        if let Ok(rcm_sym) = analyze_with(a.n, &a.col_ptr, &a.row_idx, &base.clone().with_ordering(OrderingMethod::Rcm)) {
            if let Ok(rf) = factor_numeric(&rcm_sym, &a, &base) {
                if let Ok(rx) = solve_ldlt(&rf, &b) {
                    if rel_residual(&a, &rx, &b) < 1e-4 { n_rcm += 1; }
                }
            }
        }

        println!("[val] {validated:3}. {name:<22} n={:<8} nnz={:<9} res={res:.1e}", a.n, a.row_idx.len());
    }
