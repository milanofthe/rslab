...
class Klu(_Factor):
    ...
    def refactor(self, data: NDArray[Any]) -> None: ...
...
class LdltSymbolic(_Symbolic):
    ...
    def factor(self, data: NDArray[Any], settings: Settings | None = ..., **kwargs: Any) -> Ldlt: ...
...
class LuSymbolic(_Symbolic):
    ...
    @property
    def settings(self) -> Settings: ...
    def factor(self, data: NDArray[Any], settings: Settings | None = ..., **kwargs: Any) -> Lu: ...
...
class KluSymbolic(_Symbolic):
    ...
    def factor(self, data: NDArray[Any], settings: KluSettings | None = ..., **kwargs: Any) -> Klu: ...
